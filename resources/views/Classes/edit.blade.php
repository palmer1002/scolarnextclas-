                    ...
                    <form action="{{ route('classes.update', $class->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="annee_scolaire" class="form-control @error('annee_scolaire') is-invalid @enderror" value="{{ old('annee_scolaire', $class->annee_scolaire) }}" required>
