...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('bulletins.summary') }}" class="btn btn-outline-primary">
                <i class="fas fa-list-ol me-1"></i> Palmarès par Classe
            </a>
                ...
                <tr>
                    ...
                    <td class="text-end pe-4">
                        <div class="d-flex justify-content-end gap-1">
                            ...
                            <a href="{{ route('bulletins.exportPdf', [$bulletin->eleve_id, $bulletin->type_periode . '-' . $bulletin->numero_periode]) }}" class="btn btn-sm btn-outline-danger" title="Télécharger PDF">
                                <i class="fas fa-file-pdf"></i>
                            </a>
                            @if(auth()->user()->role === 'admin' || auth()->user()->role === 'secretaire')
                                <form action="{{ route('bulletins.destroy', $bulletin->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce bulletin ?');">
                                    @csrf
                                    @method('DELETE')
